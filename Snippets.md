...
_TypeScript_ has own components and own snippets. Use search or just type `ts`
...
- Hooks from [official docs](https://reactjs.org/docs/hooks-reference.html) are
  added with hook name as prefix.
